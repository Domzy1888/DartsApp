...
# --- 2. THE DOUBLE-HANDSHAKE SYNC ---
cookie_manager = stx.CookieManager(key="persistent_darts_manager")

# We create a placeholder to stop the app from running until cookies are ready
if 'auth_checked' not in st.session_state:
    with st.spinner("Syncing your locker..."):
        time.sleep(1.5) # Increased for mobile network latency
    ...
    if st.sidebar.button("Go"):
        ...
        if not u_df.empty:
            ...
            if not match.empty:
                ...
                st.session_state['logging_out'] = False
                # Setting cookie with path="/" for better mobile persistence
...
# --- SCORING & PAGES (Logic remains exactly as before) ---
        ...
        if days:
            ...
            with st.form("prediction_form", clear_on_submit=False):
                ...
                for _, row in day_matches.iterrows():
                    ...
                    timer = f"<div class='timer-text'>Starts soon</div>"
